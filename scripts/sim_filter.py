...
# # WIP
# # let's make a continuous raw of 40 events
# shifts = np.ceil(np.random.normal(0,1, 40) * 10)
# events = []
# for shift in shifts:
#     events.append(np.hstack([N400[shift:], N400[:shift]]))
#
# N400_raw = np.hstack(events)
